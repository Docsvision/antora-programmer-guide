...
|`xref:CardData.LockOwner_PR.adoc[LockOwner]` |Возвращает название учётной записи субъекта заблокировавшего карточку.
...
|`xref:CardData.Type_PR.adoc[Type]` |Описание метаданных типа карточки.
