...
|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.AddressInfo_CL.adoc[LegalAddress]`
|Полный адрес иностранной организации в стране регистрации (инкорпорации) (Обязательный).

|`xref:BackOffice-ObjectModel-Powers:PowerOfAttorneyFNSDOVEL503RevocationData.SeparateSubdivisionManagerInfo_CL.adoc[Manager]`
