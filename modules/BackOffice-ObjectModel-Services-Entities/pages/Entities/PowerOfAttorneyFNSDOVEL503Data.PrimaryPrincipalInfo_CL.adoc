...
|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.RussianCompanyInfo1_CL.adoc[RussianCompany]`
...
|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.ForeignCompanyInfo1_CL.adoc[ForeignCompany]`
...
|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.IndividualInfo2_CL.adoc[Individual]`
