...
|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.PrimaryPowerOfAttorneyInfo_CL.adoc[PrimaryPowerOfAttorney]`
|Сведения об основной доверенности (Обязательный).

|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.ParentPrincipalInfo_CL.adoc[ParentPrincipal]`
