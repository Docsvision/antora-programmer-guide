...
NOTE: Формат 5.02 устарел. Формируйте доверенности в формате 5.03, xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data_CL.adoc[PowerOfAttorneyFNSDOVEL503Data]])
