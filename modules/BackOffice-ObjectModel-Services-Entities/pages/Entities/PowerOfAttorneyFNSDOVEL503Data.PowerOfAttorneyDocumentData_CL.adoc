...
|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.PowerOfAttorneyInfo_CL.adoc[PowerOfAttorney]`
|Сведения доверенности (Обязательный).

|`xref:BackOffice-ObjectModel-Powers:PowerOfAttorneyFNSDOVEL503RevocationData.PrincipalInfo_CL.adoc[Principal]`
