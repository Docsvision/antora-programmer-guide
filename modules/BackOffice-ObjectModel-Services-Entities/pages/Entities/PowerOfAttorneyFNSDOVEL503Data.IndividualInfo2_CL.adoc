...
|`http://msdn.microsoft.com/ru-ru/library/system.string.aspx[RecordNumberOfFederalPopulationRegister]`
|Номер записи федерального регистра сведений о населении
...
|`xref:BackOffice-ObjectModel-Powers:PowerOfAttorneyFNSDOVEL503RevocationData.FIO_CL.adoc[Fio]`
|Фамилия, имя, отчество физического лица (Обязательный).

|`xref:BackOffice-ObjectModel-Powers:PowerOfAttorneyFNSDOVEL503RevocationData.IdentityCardInfo_CL.adoc[IdentityCard]`
