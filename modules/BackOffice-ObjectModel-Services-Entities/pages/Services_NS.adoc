...
|`xref:BackOffice-ObjectModel-Services:IEventHandlerProviderService_IN.adoc[IEventHandlerProviderService]` |Поставщик сервисов для обработки событий.
|`xref:BackOffice-ObjectModel-Services:IEventHandlerProviderService2_IN.adoc[IEventHandlerProviderService2]` |Поставщик сервисов для обработки событий.
|`xref:BackOffice-ObjectModel-Services:IEventHandlerService_IN.adoc[IEventHandlerService]` |Сервис обработки событий.
...
|`xref:BackOffice-ObjectModel-Powers:IPowerOfAttorneyMachineReadableProvider_IN.adoc[IPowerOfAttorneyMachineReadableProvider]` |Определяет методы формирования и чтения машиночитаемой доверенности.
|`xref:BackOffice-ObjectModel-Powers:IPowerOfAttorneyService_IN.adoc[IPowerOfAttorneyService_IN]` |Предоставляет методы для работы с системной карточкой доверенности.
