...
|`SearchCardId` |Задает или возвращает идентификатор карточки сохранённых поисковых запросов.
|`ViewCardId` |Задает или возвращает идентификатор текущей карточки сохранённых представлений.
|===
