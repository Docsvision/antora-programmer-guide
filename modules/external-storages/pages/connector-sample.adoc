...
. Добавьте новое хранилище. В окне настройки хранилища в поле _Тип_ нужно выбрать вариант *_Добавить из сборки_* и указать имя файла `GoogleDriveStorageProvider` из каталога на сервере. В список типов хранилищ будет добавлено хранилище с названием "Хранилище в Google Drive".
. Настройте новое хранилище с типом "Хранилище в Google Drive", группу и правило помещения в хранилище следуя инструкции, приведенной в xref:dev@mgmtconsole:servers:db-storage.adoc[документации модуля {mc}].
+
