...
. Microsoft Visual Studio {vscode-v} или выше.
. {net-f}.
...
+
. В список типов хранилищ будет добавлено хранилище с названием "Хранилище в Google Drive". Настройте для нового хранилища группу и правило, следуя инструкции, приведенной в разделе "xref:6.2@mgmtconsole:servers:db-storage-setup.adoc[]" документации модуля {mc}.
