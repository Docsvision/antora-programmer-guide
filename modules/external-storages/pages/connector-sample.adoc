...
+
. В список хранилищ будет добавлено хранилище с названием "Хранилище в Google Drive". Настройте для нового хранилища группу и правило, следуя инструкции, приведенной в разделе "xref:dev@mgmtconsole:servers:db-storage-setup.adoc[]" документации модуля {mc}.
