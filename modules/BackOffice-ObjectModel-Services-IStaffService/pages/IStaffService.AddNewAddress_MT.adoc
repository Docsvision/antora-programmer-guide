...
type:::
Тип: `xref:BackOffice-ObjectModel:StaffAddresseAddressType_EN.adoc[StaffAddresseAddressType]`
+
Подразделение, для которого добавляется адрес

Возвращаемое значение::
Тип: `xref:BackOffice-ObjectModel:StaffAddresse_CL.adoc[StaffAddresse]`
+
Адрес подразделения
