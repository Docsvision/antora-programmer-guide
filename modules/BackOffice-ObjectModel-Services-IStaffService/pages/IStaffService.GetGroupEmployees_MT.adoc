...
Параметры::
group:::
Тип: `xref:xref:BackOffice-ObjectModel-Staff:StaffEmployee_CL.adoc[StaffGroup]`
+
Группа сотрудников
...
+
Коллекция выбранных сотрудников типа `xref:xref:BackOffice-ObjectModel-Staff:StaffEmployee_CL.adoc[StaffEmployee]`
