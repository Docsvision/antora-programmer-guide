...
|`xref:IVersionedFileCardService.GetLockOwner_MT.adoc[GetLockOwner(VersionedFileCard)]` |Возвращает имя учётной записи сотрудника, заблокировавшего версионный файл.
...
VersionedFileCard versionedFileCard = iVersionedFileCardService.CreateCard(@"..\test.txt"); <.>
