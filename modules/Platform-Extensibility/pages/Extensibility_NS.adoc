...
|`xref:NavPickerAccountTypes_EN.adoc[NavPickerAccountTypes]` |Определяет тип учётной записи.
|`xref:NavPickerNameFormat_EN.adoc[NavPickerNameFormat]` |Определяет формат имени учётной записи.
