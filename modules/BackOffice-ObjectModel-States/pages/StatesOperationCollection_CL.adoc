...
Данный класс предоставляет методы для работы с коллекцией операций `xref:StatesOperation_CL.adoc[StatesOperation]`, зарегистрированных в _Конструкторе состояний_..
