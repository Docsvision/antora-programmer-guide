...
Класс `StatesStateCollection` предоставляет методы для работы с коллекцией состояний `xref:StatesState_CL.adoc[StatesState]`, определённых в _Конструкторе состояний_.
