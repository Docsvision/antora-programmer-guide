...
Коллекция видов карточек может быть получена, например, из свойства типа карточки: `xref:BackOffice-ObjectModel:KindsCardType.Kinds_PR.adoc[KindsCardType.Kinds]`.
