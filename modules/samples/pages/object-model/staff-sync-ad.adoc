...
Чтобы синхронизация могла быть выполнена необходимо связать элемент _Справочника сотрудников_ и объект Active Directory. Подробнее об этом читайте в разделе xref:6.1@backoffice:desdirs:staff/active-directory-sychronization.adoc[по ссылке].
