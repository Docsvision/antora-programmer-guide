...
[NOTE]
====
Пример получения контекста объектов приведен в разделе xref:object-model/init-context.adoc[Инициализация контекста объектов], а также в исходных кодах данного проекта.
====
+
