...
[NOTE]
====
Исходный код _SnapIn_ расположен в подкаталоге `NetstatSolutionClientInstaller` https://github.com/Docsvision/WebClient-Samples/tree/master/Others/NetStatSolution[репозитория] проекта.
====
