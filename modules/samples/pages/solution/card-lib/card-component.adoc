...
[NOTE]
====
Исходный код компонента карточки расположен в подкаталоге `NetstatSolutionCard` https://github.com/Docsvision/WebClient-Samples/tree/master/Others/NetStatSolution[репозитория].
====
