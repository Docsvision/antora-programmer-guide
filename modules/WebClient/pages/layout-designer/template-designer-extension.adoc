...
. Убедитесь, что установлен https://github.com/Docsvision/WebClient-Samples/tree/master/Install/WebClientSDK[{dv} WebClient SDK].
+
...
// . Скопируйте `safeprojectnamesafeprojectname.dll` и `safeprojectnamesafeprojectname.dll.pdb` из папки `bin/Plugins` в `{wcd-lin}/Plugins`.
// +
// Ресурсные сборки скопируйте в папки `{wcd-lin}/ru/` (для русской локализации), `{wcd-lin}/uk/` (для английской локализации) и т.д.
// +
// . Перезапустите {kvr}.
