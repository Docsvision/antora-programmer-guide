...
. Скопируйте каталог `SamplesOutput\Extensions\ShiftTasksEndDateServerExtension` в каталог `Путь к сайту {wc}а\Extensions`.
. Скопируйте файл `SamplesOutput\Extensions\ru\ShiftTasksEndDateServerExtension.resources.dll` в каталог "`Путь к сайту {wc}а\Extensions\ru`".
. Скопируйте файл `SamplesOutput\Extensions\uk\ShiftTasksEndDateServerExtension.resources.dll` в каталог `Путь к сайту {wc}а\Extensions\uk`.
. Скопируйте каталог`SamplesOutput\Content\Modules\ShiftTasksEndDateWebExtension` в каталог `Путь к сайту {wc}а\Content\Modules`.
+
