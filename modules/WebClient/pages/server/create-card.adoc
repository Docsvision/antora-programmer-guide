...
. Скопируйте каталог `SamplesOutput\Content\Modules\CreateCardWebExtension` в каталог `Путь к сайту {wc}а\Content\Modules`.
. Скопируйте каталог `SamplesOutput\Extensions\CreateCardServerExtension` в каталог `Путь к сайту {wc}а\Extensions`.
+
