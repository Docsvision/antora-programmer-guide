...
Проект содержит объектную модель карточки типа `CustomDirectory`. Подробности содержатся в xref:cards:edit-card.adoc[руководстве разработчика {dv}].
