...
+
****
include::TSK-11773@webclient:ROOT:partial$excerpts.adoc[tags=versions]
****
+
...
В ресурсной поставке рекомендуется устанавливать сборки в папку menu:Site[Extensions], чтобы проще было видеть, какие расширения установлены в {wc}е. Однако этот способ требует перезапуска IIS при установке или обновлении сборки.
====
+
