...
. Скопируйте каталог `SamplesOutput\Extensions\CustomConditionTypesInterfaces` в каталог `Путь к сайту {wc}а\Extensions`.
. Скопируйте каталог `SamplesOutput\Extensions\CustomConditionTypesLayoutExtension` в каталог `Путь к сайту {wc}а\Extensions`.
+
