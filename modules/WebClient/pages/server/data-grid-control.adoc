...
ЭУ xref:webclient:layouts:ctrl/table/dataGridControl.adoc[Контрол табличных данных] отображает данные в виде таблицы, наполняемой при помощи плагина. На данной странице описан способ создания плагина.
