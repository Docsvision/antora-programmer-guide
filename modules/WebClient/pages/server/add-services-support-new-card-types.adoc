...
----
<.> Далее следует стандартный код добавления фабрик в контекст объектов (см. xref:samples:object-model/init-context.adoc[Руководство разработчика {dv}]).
