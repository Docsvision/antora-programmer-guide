...
. Скопировать каталог `SamplesOutput\Extensions\ExtendedCardInfoServerExtension` в каталог `Путь к сайту {wc}а\Extensions`.
. Скопируйте файл `SamplesOutput\Extensions\ru\ExtendedCardInfoServerExtension.resources.dll` в каталог `Путь к сайту {wc}а\Extensions\ru`.
. Скопируйте файл `SamplesOutput\Extensions\uk\ExtendedCardInfoServerExtension.resources.dll` в каталог `Путь к сайту {wc}а\Extensions\uk`.
. Скопируйте каталог `SamplesOutput\Content\Modules\ExtendedCardInfoWebExtension` в каталог `Путь к сайту {wc}а\Content\Modules`.
+
