...
.. Скопируйте папку `SamplesOutput\Content\Modules\SignalForUsersWebExtension\` в `Путь к сайту {wc}а\Content\Modules`.
.. Скопируйте папку `SamplesOutput\Extensions\SignalForUsersExtension` в `Путь к сайту {wc}а\Extensions`.
.. Перезапустите службу Сервера {wc}а.
