...
.. Скопируйте папку `SamplesOutput\Content\Modules\KonturWebExtension\` в  `Путь к сайту {wc}а\Content\Modules`.
.. Скопируйте папку `SamplesOutput\Extensions\KonturServerExtension` в  `Путь к сайту {wc}а\Extensions`.
