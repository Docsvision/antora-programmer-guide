...
include::new-admin-console@webclient:ROOT:partial$excerpts.adoc[tags=n-6]
...
* При помощи создания нового проекта, нацеленного на .NET 8. При создании проекта предпочтительно использовать шаблоны VisualStudio из https://github.com/Docsvision/WebClient-Samples/tree/master/ProjectTemplates[примеров разработки расширений] для версии 6.1.
...
В {wc}е 18 (6.1) вместо Autofac используется стандартный механизм внедрения зависимостей .NET. В связи с этим в классе серверного расширения нужно произвести следующие изменения:
