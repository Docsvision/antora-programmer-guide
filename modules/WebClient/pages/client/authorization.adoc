...
image::5.5.17@webclient:admin:authentication-email.png[Страница входа с указанным адресом электронной почты администратора]
...
Чтобы изменить вид страницы входа, разработайте собственные скрипты По инструкции ниже и поместите их в папку `{wcd-win}\Site\Content\Account\Scripts`.
