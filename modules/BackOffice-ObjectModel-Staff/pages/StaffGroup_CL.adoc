...
|===
|Имя |Описание
|`AccountName` |Задаёт или возвращает название учётной записи, связанной с группой.
|`AccountSId` |Задаёт или возвращает SID учётной записи, связанной с группой.
...
|===
|Имя |Описание
|`AccountNameProperty` |Представляет свойство "Учётная запись".
|`AccountSIDProperty` |Представляет свойство "SID учётной записи".
