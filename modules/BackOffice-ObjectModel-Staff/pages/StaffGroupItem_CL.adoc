...
|===
|Имя |Описание
|`Employee` |Задаёт или возвращает сотрудника группы.
|`EmployeeId` |Задаёт или возвращает идентификатор сотрудника группы.
|`Group` |Задаёт или возвращает текущую группу.
|`Role` |Задаёт или возвращает роль сотрудника в группе или в _рабочей группе_.
|===
