...
a|Создаёт новую СКД в рамках передоверия для представителя -- физического лица
...
a|Создаёт новую СКД в рамках передоверия для представителя -- юридического лица
