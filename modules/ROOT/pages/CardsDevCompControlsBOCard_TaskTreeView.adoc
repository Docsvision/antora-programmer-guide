...
Элемент управления TaskTreeView предназначен для наглядного отображения жизненного цикла карточек _Задание_ и _Группа заданий_. Соответствует элементу управления *Дерево исполнения* _Конструктора разметок_.
