...
.. Перейдите в раздел Настройки сервера/Базы данных. Выберите настраиваемую БД и нажмите кнопку *Настройка*. Будет открыто окно "Свойства и управление базой данных".
.. Перейдите на страницу "Внешние хранилища".
.. Добавьте новое хранилище. В окне настройки хранилища в поле *Тип* нужно выбрать вариант "Добавить из сборки" и выбрать файл `GoogleDriveStorageProvider.dll` из каталога GAC. В список типов хранилищ будет добавлено хранилище с названием "Хранилище в Google Drive".
...
+
image::ConfigurationGoogleStoragePanel.png[Figure 1. Пример настройки хранилища в Google Drive]
+
