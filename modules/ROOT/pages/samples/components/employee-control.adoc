...
image::usercontrol_visualstudio.png[Элемент управления "Сотрудник с фотографией"]
...
image::hide-inactive.png[Флаг "Скрывать неактивных сотрудников"]
...
image::user-with-photo.png[Элемент управления "Сотрудник с фотографией" на панели инструментов]
...
image::usercontrol_layoutsdesigner_control_config.png[Настройки элемента управления "Сотрудник с фотографией"]

При работе с карточкой элемент управления _Сотрудник с фотографией_ выглядит так:

."Сотрудник с фотографией" в карточке
image::control-in-card.png["Сотрудник с фотографией" в карточке]
