...
[NOTE]
====
Полное описание свойств класса `SynchronizationDepartmentsSettings` смотрите в описании интерфейса xref:api/DocsVision/BackOffice/ObjectModel/Services/Entities/ActiveDirectory/ADSync/IADSynchronizationSettings_IN.adoc[`IADSynchronizationSettings`].
====
