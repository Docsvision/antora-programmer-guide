...
* xref:development-manual/dm_appendix_webservice_connection_sessiongetlist.adoc[SessionGetList] -- возвращает список открытых подключений к серверу.
* xref:development-manual/dm_appendix_webservice_connection_sessiongetsettings.adoc[SessionGetSettings] -- возвращает данные пользовательской сессии.
