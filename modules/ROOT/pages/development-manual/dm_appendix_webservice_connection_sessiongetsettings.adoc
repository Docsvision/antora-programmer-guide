...
Ответ содержит полный набор сведений о пользовательской сессии (см. xref:development-manual/dm_appendix_usersessionproperties.adoc[Список свойств пользовательской сессии]).
