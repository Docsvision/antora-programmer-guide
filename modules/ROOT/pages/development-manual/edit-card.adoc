...
На высоком уровне API сценарий изменения данных зависит от способа  xref:development-manual/get-section.adoc[представления секции] в объектной модели карточки.
