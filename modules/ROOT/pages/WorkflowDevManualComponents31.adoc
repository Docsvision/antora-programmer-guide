...
Код сценарий может быть написан непосредственно в диалоговом окне *Редактирование скрипта* Написание кода _сценария_ можно производить как непосредственно в диалоговом окне _функции_ _сценария_, так и в любом другом редакторе или при помощи Visual Studio.NET -- с последующей вставкой полученного кода в _функцию_ процесса.
