...
[IMPORTANT]
====
Данный метод не загружает содержимое файла в созданную в {dv} сущность -- для этого необходимо использовать метод xref:appendix/DevManualAppendix_WebService_Files_FileWrite.adoc[FileWrite].
====
