...
|Recipient |Автор |refid | |Поля ссылки: Recip_FName > FirstName, Recip_MName > MiddleName, Recip_LName > LastName
...
|RecipientDep |Подразделение автора |refid | |Поля ссылки: Recip_DepName > Name, Recip_DepFullName > FullName
|ResponsibleDep |Подразделение ответственного |refid | |Поля ссылки: Resp_DepName > Name, Resp_DepFullName > FullName
|RecipientPosition |Должность автора |refid | |Поля ссылки: Recip_Position > Name
|ResponsiblePosition |Должность ответственного |refid | |Поля ссылки: Resp_Position > Name
...
.[.table--title-label]##Табл. 11. ##[.title]##Поля секции "Журнал передач"##
[width="100%",cols="20%,20%,20%,20%,20%",options="header",]
|===
|Псевдоним |Название |Тип поля |Размер |Дополнительная информация
...
.[.table--title-label]##Табл. 12. ##[.title]##Режимы работы карточки##
...
.[.table--title-label]##Табл. 13. ##[.title]##Действия карточки##
[width="99%",cols="34%,33%,33%",options="header",]
|===
|Псевдоним |Идентификатор |Описание
