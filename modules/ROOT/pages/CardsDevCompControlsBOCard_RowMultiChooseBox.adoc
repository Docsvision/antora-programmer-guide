...
Элемент управления RowMultiChooseBox предназначен для выбора нескольких значений: из различных справочников; из различных секций одного справочника. Соответствует элементу управления *Коллекция значений* _Конструктора разметок_.
