...
Практическая информация по разработке _преобразователя данных_ содержится в разделе xref:develop/cards/object-model/mapper.adoc[Разработка преобразователя данных].
