...
|xref:api/DocsVision/Platform/WinForms/Controls/Controls_NS.adoc[Controls] |Пространство имен Controls содержит коллекцию элементов управления WinForms, используемых в карточках {dv}.
|DataSource |Коллекция источников данных для карточек.
|xref:api/DocsVision/Platform/WinForms/SystemDialogs/SystemDialogs_NS.adoc[SystemDialogs] |Пространство имен SystemDialogs содержит формы различных диалоговых окон, используемых {wincl}ом.
|===
