...
* [.keyword]*Пространство имен:* xref:ExportDialog_NS.adoc[DocsVision.Platform.WinForms.SystemDialogs.ExportDialog]
* [.keyword]*Сборка:* [.ph .filepath]`DocsVision.Platform.WinForms.SystemDialogs.dll`
...
При печати собственного XML-документа список доступных преобразований печати и экспорта будет ограничен преобразованиями имеющими тип `Custom` (см. раздел xref:../../../../../../pages/CardsDevDataSchemeSecTransformations.adoc[Раздел 'Transformations']).
...
*На уровень выше:* xref:../../../../../../api/DocsVision/Platform/WinForms/SystemDialogs/ExportDialog/ExportDialog_NS.adoc[ExportDialog - пространство имен]
