...
Освобождает ресурсы объектов `xref:api/DocsVision/Platform/WinForms/CardControl.CardFrame_PR.adoc[CardFrame]` и `xref:api/DocsVision/Platform/WinForms/CardControl.CardHost_PR.adoc[CardHost]`.
