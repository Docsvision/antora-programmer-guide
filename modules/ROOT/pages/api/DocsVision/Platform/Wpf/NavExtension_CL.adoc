...
* *Пространство имен:* xref:xref:api/DocsVision/Platform/Wpf/Wpf_NS.adoc[DocsVision.Platform.Wpf]
...
|===
|Имя |Описание
|xref:xref:api/DocsVision/Platform/Wpf/NavExtension.SupportedTypes_PR.adoc[SupportedTypes] |Возвращает список элементов Windows-клиента, для которых предназначено данное расширение.
|===
