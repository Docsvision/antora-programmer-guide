...
|`xref:api/DocsVision/Platform/ObjectManager/CardManager.GetDictionary_1_MT.adoc[GetDictionary(Guid, Boolean)]` |Возвращает ссылку на программный интерфейс справочника с обновлением кэша.
...
|`xref:api/DocsVision/Platform/ObjectManager/CardManager.GetDictionaryData_1_MT.adoc[GetDictionaryData(Guid, Boolean)]` |Возвращает данные справочника указанного типа с обновлением кэша.
