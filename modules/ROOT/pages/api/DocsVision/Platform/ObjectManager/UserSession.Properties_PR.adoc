...
Список и описание всех параметров приведен в разделе xref:development-manual/dm_appendix_usersessionproperties.adoc[Список свойств пользовательской сессии].
