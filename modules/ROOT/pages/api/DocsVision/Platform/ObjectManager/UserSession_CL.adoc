...
|===
|Имя |Описание
|`xref:api/DocsVision/Platform/ObjectManager/UserSession.AccessManager_PR.adoc[AccessManager]` |Предоставляет _менеджера_ по работе с объектами безопасности.
