...
|===
|Имя |Описание
|`xref:api/DocsVision/Platform/CardHost/RefreshEventArgs_CT.adoc[RefreshEventArgs(Boolean)]` |Инициализирует новый экземпляр класса RefreshEventArgs с возможностью полного обновления данных.
|===
