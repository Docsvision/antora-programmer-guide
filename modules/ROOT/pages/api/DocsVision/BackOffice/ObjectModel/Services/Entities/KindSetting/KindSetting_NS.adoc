= DocsVision.BackOffice.ObjectModel.Services.Entities.KindSetting - пространство имен
...
|===
|Класс |Описание
|xref:CardFieldSetting_CL.adoc[CardFieldSetting] |Предоставляет параметры атрибута, включаемого в подпись и определенного в Справочника видов карточек.
...
|xref:DocumentSetting_CL.adoc[DocumentSetting] |Предоставляет настройки вида документа, определенные в [.dfn .term]_Справочнике видов карточек_.
...
|xref:TaskGroupSetting_CL.adoc[TaskGroupSetting] |Содержит настройки вида группы заданий.
...
|xref:TaskSetting_CL.adoc[TaskSetting] |Предоставляет настройки определенного вида задания.
|===
...
|xref:ChildTaskKindType_EN.adoc[ChildTaskKindType] |Определяет вид подчиненного задания у карточки задания или группы заданий.
|xref:CompletionParameterDemand_EN.adoc[CompletionParameterDemand] |Определяет признаки обязательности заполнения поля до завершения задания.
|xref:CompletionParameterDisplayType_EN.adoc[CompletionParameterDisplayType] |Определяет форматы отображения вариантов завершения задания.
|xref:DocumentLoadSource_EN.adoc[DocumentLoadSource] |Определяет источники загрузки основных файлов карточки Документ.
|xref:ExtensionSettingType_EN.adoc[ExtensionSettingType] |Определяет типы атрибута ExtensionSettingAttribute.
|xref:TaskAutoCompletionType_EN.adoc[TaskAutoCompletionType] |Определяет варианты автоматического завершения задания при завершении подчиненных заданий.
|xref:TaskDependingCompletionType_EN.adoc[TaskDependingCompletionType] |Определяет варианты завершения задания при невозможности завершения связанных заданий.
|xref:TaskRoutingType_EN.adoc[TaskRoutingType] |Определяет допустимые типы маршрутизации задания.
|===
