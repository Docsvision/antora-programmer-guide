...
Данный метод добавляет новую подпись в список подписей карточки [.dfn .term]_Задание_, и устанавливает ЭЦП на указанные поля карточки.
...
Ниже приведен пример скрипта, который позволяет осуществить подписание операции в карточке [.dfn .term]_Задание_. Обычно подписание осуществляется автоматически, в соответствии с настройками вида в [.dfn .term]_Справочнике видов карточек_
