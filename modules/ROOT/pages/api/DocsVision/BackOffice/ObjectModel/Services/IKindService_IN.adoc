...
|`xref:api/DocsVision/BackOffice/ObjectModel/Services/IKindService.AddProcessSettings_MT.adoc[AddProcessSettings(KindsCardKind, Guid, String)]` |Добавляет бизнес-процесс с настройками к указанному виду карточки.
