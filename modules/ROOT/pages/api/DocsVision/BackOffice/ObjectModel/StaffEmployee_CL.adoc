...
|xref:StaffEmployee.Deputies_PR.adoc[Deputies] |Задает или возвращает заместителей сотрудника.
...
|xref:StaffEmployee.InactiveStatus_PR.adoc[InactiveStatus] |Задает или возвращает состояние сотрудника в период неактивности.
...
|xref:StaffEmployee.Pictures_PR.adoc[Pictures] |Задает или возвращает коллекцию фотографий сотрудника.
|xref:StaffEmployee.Position_PR.adoc[Position] |Задает или возвращает должность сотрудника.
...
|xref:StaffEmployee.Status_PR.adoc[Status] |Задает или возвращает текущее состояние сотрудника.
