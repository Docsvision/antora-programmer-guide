= DocsVision.BackOffice.ObjectModel - пространство имен
...
|xref:Mapping/Mapping_NS.adoc[DocsVision.BackOffice.ObjectModel.Mapping] |Пространство имен DocsVision.BackOffice.ObjectModel.Mapping содержит фабрику преобразователей данных и сами преобразователи для базовых объектов.
|xref:Services/Services_NS.adoc[DocsVision.BackOffice.ObjectModel.Services] |Пространство имен DocsVision.BackOffice.ObjectModel.Services содержит фабрику сервисов и сервисы для работы с базовыми объектами.
|===
...
|===
|Класс |Описание
|xref:AccessInfo_CL.adoc[AccessInfo] |Результат проверки доступности операции для вида карточки и набора исполняемых ролей.
|xref:AccessInfoOperation_CL.adoc[AccessInfoOperation] |Сопоставляет операции доступность или недоступность ее выполнения.
|xref:AccessInfoRole_CL.adoc[AccessInfoRole] |Предоставляет специфичную для ролей информацию.
|xref:BackOffice_CL.adoc[BackOffice] |Предоставляет статические методы для получения ссылок на основные справочники BackOffice.
|xref:BarcodePrintSettings_CL.adoc[BarcodePrintSettings] |Получает настройки печати штрих-кода.
|xref:BarcodePrintSettingsCollection_CL.adoc[BarcodePrintSettingsCollection] |Коллекция объектов типа BarcodePrintSettings.
|xref:BaseCard_CL.adoc[BaseCard] |Базовый класс для объектно-ориентированных карточек библиотеки "Базовые объекты".
|xref:BaseCardNumber_CL.adoc[BaseCardNumber] |Объектная модель секции "Номера" базовой карточки.
|xref:BaseCardProcess_CL.adoc[BaseCardProcess] |Предоставляет ссылку и настройки бизнес-процесса.
|xref:BaseCardProperty_CL.adoc[BaseCardProperty] |Предоставляет доступ к коллекции BaseCardPropertyField.
|xref:BaseCardPropertyField_CL.adoc[BaseCardPropertyField] |Представляет описание ссылочного поля.
|xref:BaseCardSectionRow_CL.adoc[BaseCardSectionRow] |Базовый класс для представления строки секции карточки.
|xref:BaseCardSignature_CL.adoc[BaseCardSignature] |Содержит данные ЭЦП установленной на карточку.
|xref:BaseCardSignaturePart_CL.adoc[BaseCardSignaturePart] |Представляет часть ЭЦП.
|xref:BaseCardSystemInfo_CL.adoc[BaseCardSystemInfo] |Содержит системную информацию карточки (секция "Системные свойства").
|xref:BaseDictionaryCard_CL.adoc[BaseDictionaryCard] |Базовый класс для справочников библиотеки "Базовые объекты".
|xref:BaseUniversal_CL.adoc[BaseUniversal] |Объектная модель [.dfn .term]_Конструктора справочников_.
|xref:BaseUniversalItem_CL.adoc[BaseUniversalItem] |Представляет строку в узле [.dfn .term]_Конструктора справочников_.
|xref:BaseUniversalItemCard_CL.adoc[BaseUniversalItemCard] |Объектная модель [.dfn .term]_Карточки строки справочника_.
|xref:BaseUniversalItemCardMainInfo_CL.adoc[BaseUniversalItemCardMainInfo] |Основная информация [.dfn .term]_Карточки строки справочника_.
|xref:BaseUniversalItemType_CL.adoc[BaseUniversalItemType] |Представляет узел [.dfn .term]_Конструктора справочников_.
|xref:BaseUniversalItemTypeViewField_CL.adoc[BaseUniversalItemTypeViewField] |Представляет отображаемое поле узла [.dfn .term]_Конструктора справочников_.
|xref:BuiltInBranch_CL.adoc[BuiltInBranch] |Представляет встроенный переход в автомате состояний.
|xref:BuiltInOperation_CL.adoc[BuiltInOperation] |Предоставляет методы регистрации встроенных операций и получения их свойств.
|xref:BuiltInState_CL.adoc[BuiltInState] |Представляет встроенное состояние конструктора состояний.
|xref:Calendar_CL.adoc[Calendar] |Объектная модель карточки "Бизнес-календарь".
|xref:CalendarDay_CL.adoc[CalendarDay] |Определяет свойства рабочего дня в карточке [.dfn .term]_Бизнес-календарь_.
|xref:CalendarDefaultWorkTime_CL.adoc[CalendarDefaultWorkTime] |Данные стандартного рабочего времени для карточки [.dfn .term]_Бизнес-календарь_.
|xref:CalendarMainInfo_CL.adoc[CalendarMainInfo] |Основная информация карточки [.dfn .term]_Бизнес-календарь_.
|xref:CalendarWorkTime_CL.adoc[CalendarWorkTime] |Определяет отрезок рабочего времени в карточке [.dfn .term]_Бизнес-календарь_.
|xref:CalendarYear_CL.adoc[CalendarYear] |Календарный год карточки [.dfn .term]_Бизнес-календарь_.
|xref:Categories_CL.adoc[Categories] |Объектная модель [.dfn .term]_Справочника категорий_.
|xref:CategoriesCategory_CL.adoc[CategoriesCategory] |Представляет категорию [.dfn .term]_Справочника категорий_.
|xref:CategoriesLinkedCategory_CL.adoc[CategoriesLinkedCategory] |Представляет связанную категорию [.dfn .term]_Справочника категорий_.
|xref:CategoriesMain_CL.adoc[CategoriesMain] |Основная информация [.dfn .term]_Справочника категорий_.
|xref:CategoryList_CL.adoc[CategoryList] |Объектная модель карточки [.dfn .term]_Список категорий_.
|xref:CategoryListCategory_CL.adoc[CategoryListCategory] |Представляет категорию в [.dfn .term]_Списке категорий_.
|xref:Document_CL.adoc[Document] |Объектная модель карточки "Документ".
|xref:DocumentFile_CL.adoc[DocumentFile] |Объектная модель секции "Файлы" карточки "Документ".
|xref:DocumentMainInfo_CL.adoc[DocumentMainInfo] |Объектная модель секции "Основная информация" карточки "Документ".
|xref:EmployeeCard_CL.adoc[EmployeeCard] |Класс EmployeeCard представляет объектную модель карточки сотрудника.
|xref:EmployeeCardMainInfo_CL.adoc[EmployeeCardMainInfo] |Класс EmployeeCardMainInfo представляет объектную модель секции "Основная информация" [.dfn .term]_Карточки сотрудника_.
|xref:Kinds_CL.adoc[Kinds] |Объектная модель карточки "Справочник видов карточек".
|xref:KindsCardCreationSetting_CL.adoc[KindsCardCreationSetting] |Представляет в [.dfn .term]_Справочнике видов карточек_ настройки режима создания вида карточки .
|xref:KindsCardExtendedSetting_CL.adoc[KindsCardExtendedSetting] |Параметры расширения [.dfn .term]_Справочника видов карточек_.
|xref:KindsCardExtendedSettingCollection_CL.adoc[KindsCardExtendedSettingCollection] |Представляет коллекцию настроек расширений видов карточек. Предоставляет метод получения настроек для расширения.
|xref:KindsCardExtendedSettingGroup_CL.adoc[KindsCardExtendedSettingGroup] |Группа настроек расширения [.dfn .term]_Справочника видов карточек_.
|xref:KindsCardExtendedSettingGroupCollection_CL.adoc[KindsCardExtendedSettingGroupCollection] |Предоставляет коллекцию сгруппированных настроек расширения [.dfn .term]_Справочника видов карточек_.
|xref:KindsCardExtendedSettingGroupSetting_CL.adoc[KindsCardExtendedSettingGroupSetting] |Настройки из группы настроек расширения [.dfn .term]_Справочника видов карточек_.
|xref:KindsCardExtendedSettingGroupSettingCollection_CL.adoc[KindsCardExtendedSettingGroupSettingCollection] |Коллекция настроек для группы расширения [.dfn .term]_Справочника видов карточек_.
|xref:KindsCardExtension_CL.adoc[KindsCardExtension] |Объектная модель расширения [.dfn .term]_Справочника видов карточек_.
|xref:KindsCardKind_CL.adoc[KindsCardKind] |Представляет вид карточки объектной модели уровня бизнес-логики.
|xref:KindsCardProcess_CL.adoc[KindsCardProcess] |Определяет параметры бизнес-процесса, запускаемого из карточки определенного вида
|KindsCardProcessBranch |Переход состояний бизнес-процесса карточки "Справочник видов карточек" (секция "Переходы состояний" ).
|xref:KindsCardProcessOperation_CL.adoc[KindsCardProcessOperation] |Определяет операцию, указанную в качестве инициирующей запуск бизнес-процесса из определенного вида карточки.
|KindsCardProcessVariable |Параметры бизнес-процесса карточки "Справочник видов карточек".
|xref:KindsCardType_CL.adoc[KindsCardType] |Представляет объектную модель типа карточки, представленного в [.dfn .term]_Справочник видов карточек_.
|Layouts |Объектная модель [.dfn .term]_Конструктора разметок_.
...
|xref:LayoutsProperty_CL.adoc[LayoutsProperty] |Объектная модель секции "Свойство карточки" карточки "Конструктор разметок".
|LinksDictionary |Объектная модель карточки "Справочник ссылок".
|xref:LinksLinkType_CL.adoc[LinksLinkType] |Тип ссылки, зарегистрированной в [.dfn .term]_Справочнике ссылок_.
...
|xref:NumerationRules_CL.adoc[NumerationRules] |Представляет [.dfn .term]_конструктор правил нумерации_.
|xref:NumerationRulesNumerator_CL.adoc[NumerationRulesNumerator] |Представляет нумератор в [.dfn .term]_конструкторе правил нумерации_.
|xref:NumerationRulesRule_CL.adoc[NumerationRulesRule] |Представляет правило нумерации [.dfn .term]_конструктора правил нумерации_.
|xref:NumerationRulesRuleItem_CL.adoc[NumerationRulesRuleItem] |Элемент правила нумерации в [.dfn .term]_конструкторе правил нумерации_.
|xref:NumerationRulesRuleItemCondition_CL.adoc[NumerationRulesRuleItemCondition] |Условие в элементе правила нумерации [.dfn .term]_конструктора правил нумерации_.
|xref:Partners_CL.adoc[Partners] |Объектная модель [.dfn .term]_Справочника контрагентов_.
...
|xref:PartnersCompany_CL.adoc[PartnersCompany] |Организация контрагента в [.dfn .term]_Справочнике контрагентов_.
...
|xref:PartnersEmployee_CL.adoc[PartnersEmployee] |Представляет сотрудника контрагента.
...
|xref:PartnersGroup_CL.adoc[PartnersGroup] |Группа подразделений контрагента в [.dfn .term]_Справочнике контрагентов_.
|xref:PartnersGroupGroup_CL.adoc[PartnersGroupGroup] |Представляет подразделение контрагента в группе [.dfn .term]_Справочника контрагентов_.
...
|xref:PartnersOrgType_CL.adoc[PartnersOrgType] |Тип юридического лица в [.dfn .term]_Справочнике контрагентов_.
|xref:PartnersPosition_CL.adoc[PartnersPosition] |Представляет должность сотрудника контрагента в [.dfn .term]_Справочнике контрагентов_.
...
|xref:ReferenceList_CL.adoc[ReferenceList] |Объектная модель карточки [.dfn .term]_Список ссылок на карточки_.
|xref:ReferenceListReference_CL.adoc[ReferenceListReference] |Ссылка в [.dfn .term]_Списке ссылок на карточки_.
|xref:RoleModel_CL.adoc[RoleModel] |Объектная модель карточки "Конструктор ролей".
...
|xref:RoleModelRole_CL.adoc[RoleModelRole] |Представляет роль в ролевой модели.
|RoleModelRoleCondition |Условие в ролевой модели.
|xref:RoleModelRoleConditionGroup_CL.adoc[RoleModelRoleConditionGroup] |Предоставляет группу условий для ролевой модели.
...
|xref:ScriptingScript_CL.adoc[ScriptingScript] |Класс ScriptingScript представляется скрипт из [.dfn .term]_Конструктора скриптов_.
...
|xref:SignatureLabel_CL.adoc[SignatureLabel] |Метка подписи из Справочника меток подписей.
...
|xref:SignatureList_CL.adoc[SignatureList] |Объектная модель карточки "Список подписей".
|xref:Staff_CL.adoc[Staff] |Класс [.keyword .apiname]#Staff# представляет объектную модель [.dfn .term]_Справочника сотрудников_.
|xref:StaffAddresse_CL.adoc[StaffAddresse] |Предоставляет адресные данные организации в [.dfn .term]_Справочнике сотрудников_.
|xref:StaffADsMapping_CL.adoc[StaffADsMapping] |Определяет соответствие между атрибутом Active Directory и названием поля в справочнике сотрудников.
...
|xref:StaffContain_CL.adoc[StaffContain] |Представляет контейнер роли в [.dfn .term]_справочнике сотрудников_.
|xref:StaffDeputy_CL.adoc[StaffDeputy] |Объектная модель заместителя сотрудника в [.dfn .term]_справочнике сотрудников_.
|StaffDepViewField |Отображаемые поля подчиненных подразделений карточки "Справочник сотрудников".
|xref:StaffEmployee_CL.adoc[StaffEmployee] |Представляет сотрудника подразделения из справочника сотрудников.
|xref:StaffEmployeesFormat_CL.adoc[StaffEmployeesFormat] |Формат отображения данных сотрудников подразделения.
...
|xref:StaffGroup_CL.adoc[StaffGroup] |Группа сотрудников [.dfn .term]_Справочника сотрудников_.
|xref:StaffGroupFolder_CL.adoc[StaffGroupFolder] |Представляет папку определенную в параметрах группы пользователей в [.dfn .term]_Справочнике сотрудников_.
|xref:StaffGroupItem_CL.adoc[StaffGroupItem] |Представляет сотрудника в группе [.dfn .term]_Справочника сотрудников_.
...
|xref:StaffPicture_CL.adoc[StaffPicture] |Фотография сотрудника в [.dfn .term]_справочнике сотрудников_.
|xref:StaffPosition_CL.adoc[StaffPosition] |Объектная модель должности сотрудника в [.dfn .term]_справочнике сотрудников_.
|StaffProperty |Свойства карточки "Справочник сотрудников".
|xref:StaffRole_CL.adoc[StaffRole] |Представляет роль в [.dfn .term]_справочнике сотрудников_.
|xref:StaffRoleFolder_CL.adoc[StaffRoleFolder] |Представляет папку роли в [.dfn .term]_справочнике сотрудников_.
...
|xref:StaffUnit_CL.adoc[StaffUnit] |Объектная модель подразделения из [.dfn .term]_Справочника сотрудников_.
|StaffUserSetting |Пользовательская настройка в карточке "Справочник сотрудников".
|xref:StatesCardKindStateSetting_CL.adoc[StatesCardKindStateSetting] |Представляет настройки вида карточки, заданные в [.dfn .term]_Конструкторе состояний_.
|xref:StatesDictionary_CL.adoc[StatesDictionary] |Объектная модель карточки "Конструктор состояний".
|xref:StatesOperation_CL.adoc[StatesOperation] |Представляет операцию зарегистрированную в конструкторе состояний.
|xref:StatesOperationCollection_CL.adoc[StatesOperationCollection] |Представляет коллекцию объектов типа StatesOperation.
|xref:StatesOperationDescription_CL.adoc[StatesOperationDescription] |Описание операции в [.dfn .term]_конструкторе состояний_.
|xref:StatesOperationName_CL.adoc[StatesOperationName] |Локализованное название операции в [.dfn .term]_конструкторе состояний_.
|xref:StatesState_CL.adoc[StatesState] |Представляет состояние из конструктора состояний.
|xref:StatesStateCollection_CL.adoc[StatesStateCollection] |Представляет коллекцию объектов типа StatesState.
|xref:StatesStateMachineBranch_CL.adoc[StatesStateMachineBranch] |Представляет переход автомата состояний.
|xref:StatesStateMachineBranchCollection_CL.adoc[StatesStateMachineBranchCollection] |Представляет коллекцию объектов типа StatesStateMachineBranch.
|xref:StatesStateMachineLayout_CL.adoc[StatesStateMachineLayout] |Класс StatesStateMachineLayout представляет разметку автомата состояний в [.dfn .term]_Конструкторе состояний_.
...
|xref:Task_CL.adoc[Task] |Объектная модель карточки [.dfn .term]_Задание_.
|xref:TaskActualDelegate_CL.adoc[TaskActualDelegate] |Предоставляет данные актуального делегата карточки [.dfn .term]_Задание_.
|xref:TaskComment_CL.adoc[TaskComment] |Комментарий к заданию в карточке "Задание".
|TaskCompletionAdditionalOption |Дополнительные опции завершения задания в карточке "Задание".
|xref:TaskCompletionOption_CL.adoc[TaskCompletionOption] |Варианты завершения задания в карточке "Задание".
|xref:TaskCompletionOptionAdditionalField_CL.adoc[TaskCompletionOptionAdditionalField] |Дополнительные атрибуты варианта завершения задания.
|xref:TaskCompletionParameter_CL.adoc[TaskCompletionParameter] |Параметры завершения задания.
|xref:TaskCurrentPerformer_CL.adoc[TaskCurrentPerformer] |Класс TaskCurrentPerformer представляет текущего исполнителя задания
|xref:TaskDelegate_CL.adoc[TaskDelegate] |Список делегирования задания в карточке "Задание".
|TaskDelegatedPerformer |Исполнитель задания в карточке "Задание".
|xref:TaskDelegatedTo_CL.adoc[TaskDelegatedTo] |Предоставляет информацию о том, кому было делегировано задание.
|xref:TaskGroup_CL.adoc[TaskGroup] |Объектная модель карточки "Группа заданий".
|TaskGroupMainInfo |Объектная модель секции "Основная информация" карточки "Группа заданий".
|xref:TaskGroupPresets_CL.adoc[TaskGroupPresets] |Представляет индивидуальные настройки исполнителя группы заданий.
|xref:TaskGroupPresetsDelegate_CL.adoc[TaskGroupPresetsDelegate] |Представляет исполнителя в индивидуальных настройках исполнителя группы заданий.
|xref:TaskGroupSelectedPerformer_CL.adoc[TaskGroupSelectedPerformer] |Выбранный исполнитель группы заданий.
|xref:TaskList_CL.adoc[TaskList] |Объектная модель карточки "Список ссылок на карточки заданий".
|xref:TaskListTask_CL.adoc[TaskListTask] |Класс TaskListTask представляется объектную модель задания, определенную в списке заданий.
|xref:TaskListTaskGroup_CL.adoc[TaskListTaskGroup] |Класс TaskListTaskGroup представляет объектную модель группы заданий, определенную в списке заданий.
|xref:TaskMainInfo_CL.adoc[TaskMainInfo] |Объектная модель секции "Основная информация" карточки "Задание".
|xref:TaskPerformer_CL.adoc[TaskPerformer] |Класс TaskPerformer представляет назначенного исполнителя здания.
|xref:TaskPreset_CL.adoc[TaskPreset] |Настройки задания в карточки "Задание".
|TaskPresetAttachmentLinkType |Настройка дополнительных типов ссылок в карточки "Задание".
|xref:TaskPresetChildCopyField_CL.adoc[TaskPresetChildCopyField] |Настройка копирования карточки "Задание".
|xref:TaskPresetChildKind_CL.adoc[TaskPresetChildKind] |Класс TaskPresetChildKind предоставляет настройки вида подчинённого задания.
|xref:TaskPresetChildKindSetting_CL.adoc[TaskPresetChildKindSetting] |Представляет вид задания, доступный для создания подчиненного задания.
|TaskPresetCompletion |Настройки завершения задания карточки "Задание".
|xref:TaskPresetDelegate_CL.adoc[TaskPresetDelegate] |Предоставляет параметры выбора делегата для задания.
...
|xref:TaskSelectedPerformer_CL.adoc[TaskSelectedPerformer] |Класс TaskSelectedPerformer представляет выбранного исполнителя задания.
|TasksTreeInfo |Инициализирует и представляет методы загрузки дерева задания.
|xref:TaskTreeInfo_CL.adoc[TaskTreeInfo] |Класс TaskTreeInfo возвращает информацию из узлу дерева заданий, полученного из списка заданий.
...
|IScriptable |Добавляет возможность хранения скрипта [.dfn .term]_Конструктора скриптов_.
|===
...
|xref:AccessInfoOperationResult_EN.adoc[AccessInfoOperationResult] |Определяет режим доступа к операции.
|xref:CalendarDayType_EN.adoc[CalendarDayType] |Определяет тип календарного дня в карточке [.dfn .term]_Бизнес-календарь_.
|xref:DeputyAccessRights_EN.adoc[DeputyAccessRights] |Определяет права заместителя сотрудника в [.dfn .term]_Справочнике сотрудников_.
|xref:DocumentFileType_EN.adoc[DocumentFileType] |Определяет тип файла документа.
|xref:DocumentVersioningType_EN.adoc[DocumentVersioningType] |Определяет тип версий файла для карточки "Документ".
|xref:KindsCardCreationSettingLocation_EN.adoc[KindsCardCreationSettingLocation] |Определяет способ размещения карточки определенного вида.
|xref:KindsCardProcessPolicy_EN.adoc[KindsCardProcessPolicy] |Определяет политику запуска бизнес-процесса для вида карточки.
|xref:KindsCardProcessVariableSync_EN.adoc[KindsCardProcessVariableSync] |Тип синхронизации параметров.
|xref:LayoutsDesignTreeType_EN.adoc[LayoutsDesignTreeType] |Определяет тип узла дерева дизайнов.
|xref:LayoutsLayoutAttributeVisibility_EN.adoc[LayoutsLayoutAttributeVisibility] |Определяет режим отображения атрибута разметки.
|xref:LayoutsPropertyItem_EN.adoc[LayoutsPropertyItem] |Определяет тип элемента управления в разметке.
|xref:LayoutsPropertyType_EN.adoc[LayoutsPropertyType] |Определяет тип свойства в конструкторе разметок.
|xref:NumerationRulesNumeratorZoneType_EN.adoc[NumerationRulesNumeratorZoneType] |Определяет режим обновления зоны нумератора.
|xref:NumerationRulesRuleItemLexeme_EN.adoc[NumerationRulesRuleItemLexeme] |Тип префикса при создании номеров нумератора.
|xref:PartnersAddresseAddressType_EN.adoc[PartnersAddresseAddressType] |Определяет тип адреса контрагента.
|PartnersChPropertyParamType |Определяет тип параметра в свойствах сотрудника контрагента.
|xref:PartnersCompanyType_EN.adoc[PartnersCompanyType] |Определяет тип подразделения контрагента в [.dfn .term]_Справочнике контрагентов_.
...
|PartnersPropertyParamType |Определяет тип параметра для свойства контрагента карточки [.dfn .term]_Справочник контрагентов_.
|xref:PartnersPropertyShowType_EN.adoc[PartnersPropertyShowType] |Определяет режим отображения свойства [.dfn .term]_Справочника контрагентов_.
...
|xref:RoleModelConditionValueDayOfWeek_EN.adoc[RoleModelConditionValueDayOfWeek] |Определяет дни недели для условий, создаваемых для ролевой модели.
|xref:RoleModelConditionValueDayWorkStatus_EN.adoc[RoleModelConditionValueDayWorkStatus] |Определяет статусы дня недели для условий, создаваемых для ролевой модели.
|xref:RoleModelConditionValueTimeWorkStatus_EN.adoc[RoleModelConditionValueTimeWorkStatus] |Определяет статус времени для условий, создаваемых для ролевой модели.
...
|xref:RoleModelRoleConditionParameter_EN.adoc[RoleModelRoleConditionParameter] |Определяет предустановленный параметр для условий. Используется ролевой моделью
|ScriptingLanguage |Определяет языки программирования, используемые [.dfn .term]_Конструктором скриптов_.
|xref:SignatureType_EN.adoc[SignatureType] |Определяет типы подписи.
|xref:StaffAddresseAddressType_EN.adoc[StaffAddresseAddressType] |Определяет тип адреса организации в [.dfn .term]_Справочнике сотрудников_.
|StaffChPropertyParamType |Определяет тип параметра в свойствах сотрудника в [.dfn .term]_Справочнике сотрудников_.
|StaffContainRefType |Тип ссылки в в [.dfn .term]_Справочнике сотрудников_.
|xref:StaffGroupRole_EN.adoc[StaffGroupRole] |Определяет роли сотрудника в рабочей группе.
|StaffEmployeeGender |Пол сотрудника в справочнике сотрудников.
|xref:StaffEmployeeInactiveStatus_EN.adoc[StaffEmployeeInactiveStatus] |Определяет возможные состояния сотрудника в период его неактивности.
|StaffEmployeeRoutingType |Определяет тип маршрутизации для сотрудника в справочнике сотрудников.
|xref:StaffEmployeeStatus_EN.adoc[StaffEmployeeStatus] |Определяет возможные состояния сотрудника организации.
|StaffNameCaseNameCase |Определяет падежи имен для сотрудников.
|xref:StaffPictureImageFormat_EN.adoc[StaffPictureImageFormat] |Определяет тип сжатия хранимой фотографии сотрудника в [.dfn .term]_справочнике сотрудников_.
...
|xref:StaffUnitType_EN.adoc[StaffUnitType] |Определяет тип подразделения в справочнике сотрудников.
...
|xref:StatesStateMachineBranchBranchType_EN.adoc[StatesStateMachineBranchBranchType] |Определяет тип перехода состояния в автомате состояний.
|SurveyListSurveyQuestionDataType |Определяет типы значений в вопросе карточки "Список опросов".
|xref:TaskCompletionOptionAdditionalFieldShowDialog_EN.adoc[TaskCompletionOptionAdditionalFieldShowDialog] |Определяет необходимость отображения поля в диалоге завершения.
|xref:TaskDelegateReason_EN.adoc[TaskDelegateReason] |Определяет возможные причины делегирования задания.
