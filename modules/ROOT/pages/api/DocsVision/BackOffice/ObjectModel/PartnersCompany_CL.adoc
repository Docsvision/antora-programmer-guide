...
Контрагент в [.dfn .term]_Справочнике контрагентов_.
...
|xref:PartnersCompany.Employees_PR.adoc[Employees] |Задает или возвращает список сотрудников контрагента.
...
|xref:PartnersCompany.Manager_PR.adoc[Manager] |Задает или возвращает руководителя контрагента.
...
|xref:PartnersCompany.OrgType_PR.adoc[OrgType] |Задает или возвращает тип юридического лица.
