...
Класс [.keyword .apiname]#ExportForm# предоставляет два варианта использования:
...
При печати собственного XML-документа список доступных пребразований печати и экспорта будет ограничен преобразованиями имеющими тип `Custom` (см. раздел xref:../../../../../pages/CardsDevDataSchemeSecTransformations.adoc[Раздел 'Transformations']).
