...
[NOTE]
====
[.note__title]#Важное замечание:# Данный метод не загружает содержимое файла в созданную в {dv} сущность -- для этого необходимо использовать метод xref:DevManualAppendix_WebService_Files_FileWrite.adoc[FileWrite].
====
