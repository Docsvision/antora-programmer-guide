...
Регистрация отчета в схеме библиотеки карточек выполняется с помощью программы «CardManager». Инструкция по работе с программой приведена в документе [.dfn .term]_Комплект программных инструментов «Resource Kit». Руководство пользователя_.
...
+
image::img/cardManagerReports.png[[.fig--title-label]##Рис. 1. ##Страница настройки отчетов библиотеки карточек в программе «CardManager»]
...
+
image::img/cardManagerReportsBaseConf.png[[.fig--title-label]##Рис. 2. ##Пример настройки основных свойств отчета]
...
+
image::img/cardManagerReportsFileConf.png[[.fig--title-label]##Рис. 3. ##Пример настройки файлов отчета]
...
+
image::img/cardManagerReportsParamConf.png[[.fig--title-label]##Рис. 4. ##Пример настройки параметров отчета]
...
+
image::img/cardManagerReportsResultConf.png[[.fig--title-label]##Рис. 5. ##Пример настройки результатов отчета]
