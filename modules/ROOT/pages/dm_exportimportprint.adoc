...
Для получения XML-представления данных карточки можно использовать метод [.keyword .apiname]#SaveXml# объектов xref:../api/DocsVision/Platform/ObjectManager/CardData_CL.adoc[CardData], xref:../api/DocsVision/Platform/ObjectManager/SectionData_CL.adoc[SectionData], xref:../api/DocsVision/Platform/ObjectManager/SubSectionData_CL.adoc[SubSectionData], и xref:../api/DocsVision/Platform/ObjectManager/RowData_CL.adoc[RowData], а также коллекций этих объектов.
...
По умолчанию, в [.dfn .term]_менеджере объектов_ реализовано 2 типа объектов-инспекторов, обладающих разным поведением:
