...
Элемент CategoryListView предоставляет функциональность выбора категории из дерева категорий. Соответствует элементу управления *Категории* _Конструктора разметок_.
