...
Элемент управления HistoryGrid предназначен для просмотра записей в журнале операций, относящихся к данной карточке. Соответствует элементу управления *История* _Конструктора разметок_.
