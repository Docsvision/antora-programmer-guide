...
+
Коллекция настроек видов (типа `xref:BackOffice-ObjectModel:TaskPresetChildKindSetting_CL.adoc[TaskPresetChildKindSetting]`) для подчиненного задания
...
Тип: `xref:BackOffice-ObjectModel:TaskPresetChildKindSetting_CL.adoc[TaskPresetChildKindSetting]`
+
