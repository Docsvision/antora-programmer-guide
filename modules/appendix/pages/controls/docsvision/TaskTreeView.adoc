...
* `*ParentTask*` -- возвращает карточку, приведенную к типу `xref:BackOffice-ObjectModel:Task_CL.adoc[DocsVision.BackOffice.ObjectModel.Task]` и указанную при инициализации в качестве родительской.
