...
[WARNING]
====
Данный метод не загружает содержимое файла в созданную в {dv} сущность -- для этого необходимо использовать метод `xref:webservice/files/FileWrite.adoc[FileWrite]`.
====
