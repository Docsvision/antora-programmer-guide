...
|`http://msdn.microsoft.com/ru-ru/library/system.string.aspx[RecordNumberOfFederalPopulationRegister]` |Номер записи федерального регистра сведений о населении
...
|`xref:BackOffice-ObjectModel-Services-Entities:Entities/PowerOfAttorneyFNSDOVEL503Data.IdentityCardInfo_CL.adoc[IdentityCard]` |Сведения о документе, удостоверяющем личность физического лица (Обязательный).
