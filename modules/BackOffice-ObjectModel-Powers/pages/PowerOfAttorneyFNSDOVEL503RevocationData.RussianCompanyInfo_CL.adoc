...
|`xref:BackOffice-ObjectModel-Powers:PowerOfAttorneyFNSDOVEL503RevocationData.PrincipalWithoutPowerOfAttorneyInfo_CL.adoc[PrincipalWithoutPowerOfAttorney]` |Сведения о лице, действующем от имени юридического лица без доверенности (Обязательный).
