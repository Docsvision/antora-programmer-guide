...
Тип: `xref:BackOffice-ObjectModel:BarcodePrintSettingsCollection_CL.adoc[BarcodePrintSettingsCollection]`
+
Настройки печати, представленные коллекцией элементов типа `xref:BackOffice-ObjectModel:BarcodePrintSettings_CL.adoc[BarcodePrintSettings]`
