...
|===
|Имя |Описание
|`xref:Schemas/SearchParametersInfo.SearchParameterInfo_PR.adoc[SearchParameterInfo]` |Задает или возвращает массив параметров, представленных в виде схемы XML, поиска объекта в базе {dv} по полям.
|===
