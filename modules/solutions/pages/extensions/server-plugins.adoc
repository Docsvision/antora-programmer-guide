...
----
{
  "DocsVision": {
    "Platform": {
      "Server": {
        "Extensions": {
          "YourExtension"="DocsVision.Your.ServerExtension.Extension, DocsVision.Your.ServerExtension, Version=6.0.0.0, Culture=neutral, PublicKeyToken=7e990517f9148af9" <.>
        }
      }
    }
  }
