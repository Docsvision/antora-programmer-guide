...
Параметры::
presets:::
Тип: `xref:BackOffice-ObjectModel:TaskGroupPresets_CL.adoc[TaskGroupPresets]`
+
Группа заданий
...
Тип: `xref:BackOffice-ObjectModel:TaskGroupPresetsDelegate_CL.adoc[TaskGroupPresetsDelegate]`
+
