...
+
Пара типа `xref:BackOffice-ObjectModel:BaseCardSignaturePart_CL.adoc[BaseCardSignaturePart]` и `http://msdn.microsoft.com/ru-ru/library/system.io.stream.aspx[System.IO.Stream]`, представляющая подписанный объект и соответствующую ему часть подписи
