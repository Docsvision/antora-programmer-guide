...
|`BaseCardExternalPowerOfAttorney(SignatureList, Guid, BaseCardExternalPowerOfAttorneyStatus);` |Добавляет стороннюю МЧД
|`BaseCardExternalPowerOfAttorney(SignatureList, Guid, BaseCardExternalPowerOfAttorneyStatus, string);` |Добавляет стороннюю МЧД
