...
|`xref:Extensibility/ExtensionMethodAttribute_1_CT.adoc[ExtensionMethodAttribute(UserRoles)]` |Инициализирует новый экземпляр класса `ExtensionMethodAttribute` с разрешенной пользовательской ролью.
|===
