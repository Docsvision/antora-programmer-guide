...
Ниже приведен пример использования метода `SyncPropertiesToFile` при синхронизации названия документа со свойствами основного файла, привязанного к документу
