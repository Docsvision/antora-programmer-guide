...
|===
|Имя |Описание
|`xref:ObjectModel/ApprovalPathMainInfo.AuthorField_PR.adoc[AuthorField]` |Задает или возвращает значение поля Автор.
|`BusinessProcessFolder` |Задает или возвращает папку бизнес-процесса.
|`xref:ObjectModel/ApprovalPathMainInfo.Name_PR.adoc[Name]` |Задает или возвращает название маршрута согласования.
|`xref:ObjectModel/ApprovalPathMainInfo.RegistratorField_PR.adoc[RegistratorField]` |Задает или возвращает значение поля Регистратор.
|===
